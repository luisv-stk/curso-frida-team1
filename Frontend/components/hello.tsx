...
const Hello: React.FC = () => {
  const { displayAddNewItem, displayUploadDetails } = useUploadStore();
    ...
    <div className="w-screen p-8 bg-[#f5f9fd] flex justify-center items-center">
      <div className="p-8 rounded-lg w-full">
        ...
        <div className="flex justify-center space-x-4">
          ...
          <button className="bg-[#0179ff] text-white px-4 py-2 cursor-pointer rounded-full" onClick={displayAddNewItem}>
